...
function execute() {
    ...
    if(!validMap1.contains("TRUE")){
     return mapName+"---> This is not a valid satellite mapping";   
    }
    else if(BkeyTest1.equals("invalidBKey")){
     return mapName+"----> This Satellite Mapping doesn't have a valid BKEY. ";
    }
    else{
...
function validMap(){
    ...
    if(mapName.contains("_S_") || tgtTblCls.equals("SAT")){
...
function Source(){
    ...
    var MappingSpecificationRow = vmappingManagerUtil.getMappingSpecifications(mapping.getMappindId());
    ...
    for (var i=0;i<MappingSpecificationRow.size();
         i++) 
    {
        if (MappingSpecificationRow.get(i)!==null) 
        {

            if (MappingSpecificationRow.get(i).getSourceTableName()!==null && !MappingSpecificationRow.get(i).getSourceTableName().equals("SYS") && !MappingSpecificationRow.get(i).getSourceTableName().equals("")) {
                sourceTable = MappingSpecificationRow.get(i).getSourceTableName();
            }
        }
    }
    ...
    for (var j=0;j<MappingSpecificationRow.size();
         j++)

        if (MappingSpecificationRow.get(j)!==null) {
            if (MappingSpecificationRow.get(j).getSourceTableName()!==null && !MappingSpecificationRow.get(j).getSourceTableName().equals("SYS") && !MappingSpecificationRow.get(j).getSourceTableName().equals("")) {
                
                
                apndFlds = MappingSpecificationRow.get(j).getSourceColumnName();
                
                 for(var keyCount=0;keyCount<apndFlds.split("\n").length;keyCount++){
                     
                    sourceColumnName = MappingSpecificationRow.get(j).getSourceColumnName().split("\n")[keyCount];
                    dataType = MappingSpecificationRow.get(j).getSourceColumnDatatype().split("\n")[keyCount];
                    dataLength = MappingSpecificationRow.get(j).getSourceColumnLength().toString().split("\n")[keyCount];
                    dataPrecision = MappingSpecificationRow.get(j).getSourceColumnLength().toString().split("\n")[keyCount];
                    dataScale = MappingSpecificationRow.get(j).getSourceColumnScale().toString().split("\n")[0];

                    if (dataType.toUpperCase().contains("NUMBER")){
                        dataType = "decimal";
                        dataLength = 4;
                        dataPrecision = 4;
                    }
                    ...
                    if (dataType.equalsIgnoreCase("BYTEINT") || dataType.toUpperCase().contains("INTEGER")){
                        dataType = "INTEGER";
                        dataLength = "10";
                        dataPrecision = "10";
                    }
                ...
                src.append("        <SOURCEFIELD BUSINESSNAME =\"\" DATATYPE =\""+dataType+"\" DESCRIPTION =\"\" FIELDNUMBER =\""+(j+keyCount+1)+"\" FIELDPROPERTY =\"0\" FIELDTYPE =\"ELEMITEM\" HIDDEN =\"NO\" KEYTYPE =\"NOT A KEY\" LENGTH =\"0\" LEVEL =\"0\" NAME =\""+sourceColumnName+"\" NULLABLE =\"NULL\" OCCURS =\"0\" OFFSET =\"0\" PHYSICALLENGTH =\""+dataLength+"\" PHYSICALOFFSET =\"0\" PICTURETEXT =\"\" PRECISION =\""+dataPrecision+"\" SCALE =\""+dataScale+"\" USAGE_FLAGS =\"\"/>\n");
            }
...
function Target(){
         ...
         i++) 
    {
        if (MappingSpecificationRow.get(i)!==null) {
            ...
            if (!MappingSpecificationRow.get(i).getTargetTableName().equals("SYS1") && MappingSpecificationRow.get(i)!==null){
                targetTable = MappingSpecificationRow.get(i).getTargetTableName();
            }
        }
    }
    ...
    for (var j=0;j<MappingSpecificationRow.size();
        ...
        if (MappingSpecificationRow.get(j)!==null) {
            ...
            if (!MappingSpecificationRow.get(j).getTargetTableName().equals("SYS")){
                if (!MappingSpecificationRow.get(j).getTargetTableName().equals("")) {

                    targetColumnName = MappingSpecificationRow.get(j).getTargetColumnName();
                    dataType = MappingSpecificationRow.get(j).getTargetColumnDatatype();
                    dataLength = MappingSpecificationRow.get(j).getTargetColumnLength();
                    dataPrecision = MappingSpecificationRow.get(j).getTargetColumnLength();
                    dataScale = MappingSpecificationRow.get(j).getTargetColumnScale();
                    targetColumnClass = MappingSpecificationRow.get(j).getTargetColumnClass();
                    
                    
                    if (targetColumnClass!==null && targetColumnClass.equalsIgnoreCase("HKEY") || targetColumnClass!==null && targetColumnClass.equalsIgnoreCase("LDTS")){
                        keyType ="PRIMARY KEY";
                        nullType ="NOTNULL";
                    }
                    else{
                    ...
                    if (dataType.toUpperCase().contains("BYTEINT") || dataType.toUpperCase().contains("INTEGER")){
                        dataType = "INTEGER";
                        dataLength = 10;
                        dataPrecision = 10;
                    }
...
//     return mappingSpecificationRows.get(0).getSourceTableName();
         ...
         y++) 
    {
        if (mappingSpecificationRows.get(y)!==null) 
        {
            ...
            if (mappingSpecificationRows.get(y).getSourceTableName()!==null && !mappingSpecificationRows.get(y).getSourceTableName().equals("SYS") && mappingSpecificationRows.get(y)!==null)  
            {
                ...
                if ("BKEY".equals(mappingSpecificationRows.get(y).getSourceColumnClass()) || mappingSpecificationRows.get(y).isSourcePrimaryKeyFlag() || mappingSpecificationRows.get(y).isSourceBusinessKeyFlag()){
                    
                    apndFlds = mappingSpecificationRows.get(y).getSourceColumnName();
                
                 for(var bkeyCount=0;bkeyCount<apndFlds.split("\n").length;bkeyCount++){
                     
                    sourceBKeyColumn = mappingSpecificationRows.get(y).getSourceColumnName().split("\n")[bkeyCount];
         ...
         i++) 
    {
        if (mappingSpecificationRows.get(i)!==null){
            ...
            if (mappingSpecificationRows.get(i).getTargetTableName()!==null && !mappingSpecificationRows.get(i).getTargetTableName().equals("SYS1") && mappingSpecificationRows.get(i)!==null){
                
                targetTable = mappingSpecificationRows.get(i).getTargetTableName();

                if ("USER".equals(mappingSpecificationRows.get(i).getTargetColumnClass())){
                    sourceUserColumn = mappingSpecificationRows.get(i).getSourceColumnName();
    ...
    for (var j=0;j<mappingSpecificationRows.size();
        ...
        if (mappingSpecificationRows.get(j)!==null) {
            if (mappingSpecificationRows.get(j).getSourceTableName()!==null && !mappingSpecificationRows.get(j).getSourceTableName().equals("SYS") && !mappingSpecificationRows.get(j).getSourceTableName().equals("")) {
                
                
                apndFlds = mappingSpecificationRows.get(j).getSourceColumnName();
                
                 for(var keyCount=0;keyCount<apndFlds.split("\n").length;keyCount++){

                    sourceColumnName = mappingSpecificationRows.get(j).getSourceColumnName().split("\n")[keyCount];

                    srcTgtCol = mappingSpecificationRows.get(j).getTargetColumnName().split("\n")[0];

                    srcDataType = mappingSpecificationRows.get(j).getSourceColumnDatatype().split("\n")[keyCount];

                    srcDataLength = mappingSpecificationRows.get(j).getSourceColumnLength().toString().split("\n")[keyCount];

                    srcDataPrecision = mappingSpecificationRows.get(j).getSourceColumnLength().toString().split("\n")[keyCount];

                    srcDataScale = mappingSpecificationRows.get(j).getSourceColumnScale().toString().split("\n")[0];
                     if(mappingSpecificationRows.get(j).getSourceColumnClass()!==null) {
                    sourceColCls = mappingSpecificationRows.get(j).getSourceColumnClass().split("\n")[0];
                     }
                    ...
                    if (srcDataType.toUpperCase().contains("VARCHAR")){
                        srcDataType = "VARCHAR";
                        srcDataLength = 500;
                        srcDataPrecision = 500;

                    }

                    if (srcDataType.toUpperCase().contains("BYTEINT") || srcDataType.toUpperCase().contains("INTEGER")){
                        srcDataType = "integer";
                        srcDataLength = "10";
                        srcDataPrecision = "10";
                    ...
                    if (srcDataType.toUpperCase().contains("DATE")){
                        srcDataType = "DATE";
                        srcDataLength = "29";
                        srcDataPrecision = "29";
                        srcDataScale = "9";
                    ...
                    if ("HKEY".equals(mappingSpecificationRows.get(j).getTargetColumnClass())){
                        sBKey=mappingSpecificationRows.get(j).getSourceColumnName();
                    }
                ...
                if(sourceColCls!==null && sourceColCls.equalsIgnoreCase("BKEY") || sourceColCls!==null && mappingSpecificationRows.get(j).isSourcePrimaryKeyFlag() || sourceColCls!==null && mappingSpecificationRows.get(j).isSourceBusinessKeyFlag()){
                ...
                if(sourceColCls.equalsIgnoreCase("BKEY") || mappingSpecificationRows.get(j).isSourcePrimaryKeyFlag() || mappingSpecificationRows.get(j).isSourceBusinessKeyFlag()){
    ...
    for (var n=0;n<mappingSpecificationRows.size();
         n++)
        if (mappingSpecificationRows.get(n)!==null) {
            ...
            if (!mappingSpecificationRows.get(n).getTargetTableName().equals("SYS1")) {
                if (mappingSpecificationRows.get(n).getTargetTableName()!==null) {
                    ...
                    if (tgtDataType.toUpperCase().contains("NUMBER")){
                        tgtDataType = "decimal";
                        tgtDataLength = "4";
                        tgtDataPrecision = "4";
                    ...
                    if (tgtDataType.toUpperCase().contains("VARCHAR")){
                        ...
                        tgtDataPrecision = tgtDataPrecision;

                    }


                    if (tgtDataType.toUpperCase().contains("BYTEINT") || tgtDataType.toUpperCase().contains("INTEGER")){
                        tgtDataType = "integer";
                        tgtDataLength = "10";
                        tgtDataPrecision = "10";
                    ...
                    if (tgtDataType.toUpperCase().contains("DATE")){
                        tgtDataType = "DATE";
                        tgtDataLength = "29";
                        tgtDataPrecision = "29";
                        tgtDataScale = "9";
                    ...
                    if ("HDIFF".equals(mappingSpecificationRows.get(n).getTargetColumnClass())){
                        md5HDiff=mappingSpecificationRows.get(n).getTargetColumnName();
                    }
                    
                     if ("HKEY".equals(mappingSpecificationRows.get(n).getTargetColumnClass())){
                        tBKey=mappingSpecificationRows.get(n).getSourceColumnName();
                    }



                    /** It will generates the port type for Expression fields */
                    if(tgtColCls!==null && tgtColCls.equalsIgnoreCase("BKEY") || tgtColCls!==null && tgtColCls.equalsIgnoreCase("USER") ){
                    ...
                    else if(tgtColCls!==null && tgtColCls.equalsIgnoreCase("HDIFF")){

                        expValue= "MD5("+HDiffData1+")";

                    }
                    else if(tgtColCls!==null && tgtColCls.equalsIgnoreCase("LDTS")){
                    ...
                    if(tgtColCls!==null && tgtColCls.equalsIgnoreCase("HKEY") || tgtColCls!==null && tgtColCls.equalsIgnoreCase("HDIFF") ){
                ...
                if(tgtColCls!==null && !tgtColCls.equalsIgnoreCase("LDTS") && !tgtColCls.equalsIgnoreCase("RSRC") && !tgtColCls.equalsIgnoreCase("")){
                if(tgtColCls!==null && tgtColCls.equalsIgnoreCase("HKEY") || tgtColCls!==null && tgtColCls.equalsIgnoreCase("HDIFF")){
                ...
                if(tgtColCls!==null && !tgtColCls.equalsIgnoreCase("HKEY") && !tgtColCls.equalsIgnoreCase("HDIFF")){
    ...
    conctJav.append("        <CONNECTOR FROMFIELD =\"PDIL_IS_ACTIVE\" FROMINSTANCE =\"JNR_SRC_VS_TGT\" FROMINSTANCETYPE =\"Joiner\" TOFIELD =\"IN_FIELD_CHAR\" TOINSTANCE =\"SC_exp_SET_DWH_COLUMNS\" TOINSTANCETYPE =\"Expression\"/> \n");
